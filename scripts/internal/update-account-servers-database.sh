...
load_dotenv .env
dotenv_files=("friends" "miiverse-api" "wiiu-chat" "super-mario-maker" "splatoon" "minecraft-wiiu" "pikmin-3" "tri-force-heroes")
...
run_verbose docker compose exec -e SERVER_IP="$SERVER_IP" \
    ...
    -e TFH_PORT="$PN_TFH_AUTHENTICATION_SERVER_PORT" \
    -e TFH_AES_KEY="$PN_TFH_AES_KEY" \
